...
- [ ] **Task 010:** Installation der NuGet-Pakete und Erstellung des `AppDbContext`.
- [ ] **Task 011:** Konfiguration der Entity-Mappings (Fluent API) für `Track` und `Playlist`.

### Feature 2: Repository Implementation
- [ ] **Task 012:** Implementierung des `SqliteTrackRepository` im Infrastructure-Layer.
- [ ] **Task 013:** Implementierung des `SqlitePlaylistRepository` im Infrastructure-Layer.

### Feature 3: Migration & Initialization
- [ ] **Task 014:** Erstellen der Initialen Migration und Logik zum automatischen DB-Setup beim Start.
